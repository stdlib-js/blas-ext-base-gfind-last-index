...
```javascript
import gfindLastIndex from 'https://cdn.jsdelivr.net/gh/stdlib-js/blas-ext-base-gfind-last-index@deno/mod.js';
```

You can also import the following named exports from the package:

```javascript
import { ndarray } from 'https://cdn.jsdelivr.net/gh/stdlib-js/blas-ext-base-gfind-last-index@deno/mod.js';
```
